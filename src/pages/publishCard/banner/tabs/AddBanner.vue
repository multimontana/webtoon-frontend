            ...
            <div class="form-keeper">
                ...
                <div class="form-element form-selects">
                    <div class="custom-select">
                        ...
                        <v-select v-model="banner.category" label="name" :options="category_options.title" :reduce="name => name.id"/>
                    </div>
                    <div class="custom-select">
                        <label>Жанр 2</label>
                ...
                <div class="button-keeper">
                    <button @click="createPost()" @submit.prevent="onSubmit()"> class="btn-green submit-button" type="submit" :style="garanture == '' || accept_conditions == '' ? 'opacity:0.5': ''" :disabled="garanture == '' || accept_conditions == ''">
                        Создать
                    </button>
...
export default {
  ...
  methods: {
    ...
    //   this.$router.push('/')
    // },
    ...mapActions(['getCategoriesAction', 'createPostAction', 'getEpisodesAction']),
    onFileChange (e, type) {
    ...
    getEpisodes () {
      ...
      console.log(this.category_options, 'hh1h')
    }
  },
  created () {
    this.getEpisodes()
