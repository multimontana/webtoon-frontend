<template>
    <hooper :itemsToShow="5.5" :infinite="true" class="cart-slider">
        <slide class="cart-item" v-for="(episode, index) in episodes" :key="index">
